...
CUDA_VISIBLE_DEVICES=1 python launch.py --config configs/magic123-refine-sd.yaml --train data.image_path=load/images/luffy_medal_rgba.png system.prompt_processor.prompt="a high-resolution DSLR image of Luffy medal" system.geometry_convert_from=outputs/magic123-coarse-sd/luffy_medal_rgba.png-a_high-resolution_DSLR_image_of_Luffy_medal@20230908-102845/ckpts/last.ckpt system.renderer.context_type=cuda
# zero123
